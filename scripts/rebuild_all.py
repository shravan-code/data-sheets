        ...
        <div class="flex-none flex items-center justify-center gap-3 md:gap-4 mx-4">
            <a href="{prefix}index.html" class="no-underline group flex items-center gap-3 transition-transform duration-300 group-hover:scale-105">
                <div class="h-9 w-auto">
                    <svg viewBox="0 0 320 120" xmlns="http://www.w3.org/2000/svg" class="h-full w-auto">
                        <!-- Cake Slice -->
                        <g transform="translate(10, 10)">
                            <!-- Bottom Layer (Navy) -->
                            <path d="M10 60 L80 90 L80 100 C80 105 75 105 70 102 L10 75 Z" fill="#0F172A" class="dark:fill-slate-400"/>
                            <!-- Middle Layer (Purple) -->
                            <path d="M10 45 L80 75 L80 90 L10 60 Z" fill="#6366F1"/>
                            <!-- Top Layer (Light Purple) -->
                            <path d="M10 30 L80 60 L80 75 L10 45 Z" fill="#C7D2FE"/>
                            <!-- Top Surface -->
                            <path d="M10 30 L45 10 L80 30 L45 50 Z" fill="white" stroke="#0F172A" stroke-width="2"/>
                            <!-- Side Outlines -->
                            <path d="M10 30 L10 75 M80 30 L80 100 M45 50 L45 95" stroke="#0F172A" stroke-width="2" fill="none" class="dark:stroke-slate-400"/>
                            <!-- Dots on top -->
                            <circle cx="35" cy="25" r="2.5" fill="#0F172A"/>
                            <circle cx="55" cy="25" r="2.5" fill="#0F172A"/>
                            <circle cx="45" cy="35" r="2.5" fill="#0F172A"/>
                        </g>
                        ...
                        <text x="100" y="75" 
                              ...
                              font-weight="800" 
                              fill="currentColor" 
                              class="text-slate-900 dark:text-white">Data Cake</text>
                    </svg>
                </div>
            </a>
