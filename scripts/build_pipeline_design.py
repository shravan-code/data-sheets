...
roadmap_phases = [
    {"name":"Phase 1 — Core Foundations","items": [
    ...
    {"name":"Phase 2 — Architecture Strategies","items": [
    ...
    {"name":"Phase 3 — Ingestion Layer","items": [
    ...
    {"name":"Phase 4 — Processing Layer","items": [
    ...
    {"name":"Phase 5 — Storage Layer","items": [
    ...
    {"name":"Phase 6 — Batch Design","items": [
    ...
    {"name":"Phase 7 — Streaming Design","items": [
    ...
    {"name":"Phase 8 — Orchestration","items": [
    ...
    {"name":"Phase 9 — Data Quality","items": [
    ...
    {"name":"Phase 10 — Pipeline Observability","items": [
    ...
    {"name":"Phase 11 — Optimization & Security","items": [
    ...
    <div id="ds-main-content">
        <main class="relative z-10 pt-24 pb-20 px-6 max-w-5xl mx-auto">
            ...
            <header class="mb-20 text-center">
                ...
                <p class="text-xl md:text-2xl text-slate-500 dark:text-slate-400 max-w-3xl mx-auto leading-relaxed font-medium italic">"Architecting robust, scalable, and observable data lifecycles for the modern data stack."
                </p>
            </header>
