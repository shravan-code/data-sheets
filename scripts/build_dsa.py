...
# Sort subpages by the numeric prefix in the title (e.g., "1. Complexity" -> 1)
subpages.sort(key=lambda x: int(x['title'].split('.')[0]) if '.' in x['title'] and x['title'].split('.')[0].isdigit() else 999)
